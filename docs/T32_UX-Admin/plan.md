...
| 4 | [04-stock-structural](tareas/04-stock-structural/04-stock-structural.md) — `StockPage`: stat-cards (el movimiento de "Registrar movimiento" a un `.card` se probó y se revirtió a pedido del usuario, ver la tarea) | 1 | ✅ Hecha |
| 5 | [05-finanzas-structural](tareas/05-finanzas-structural/05-finanzas-structural.md) — `FinanzasPage`: resumen del mes como 5 stat-cards | 1 | ✅ Hecha |
| 6 | [06-sidebar-tipografia](tareas/06-sidebar-tipografia/06-sidebar-tipografia.md) — `.sidebar-brand h2` a Cormorant Garamond | 1 | ✅ Hecha |
| 7 | [07-verificacion-final](tareas/07-verificacion-final/07-verificacion-final.md) — checklist en vivo, ≥3 pantallas, mobile, `tsc` | 1-6 | ✅ Hecha |

**T32_UX-Admin completo — las 7 tareas hechas y verificadas en vivo.** Sin
commits de mi parte: los cambios quedan en el working tree para que el
usuario los revise y commitee a su criterio.
